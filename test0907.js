...
$('#hash').on('load', function () {
    ...
    newwindow.document.querySelector('html').setAttribute('onclick','window.opener.request(document.querySelector("#user_id").value, document.querySelector("#pw").value);setTimeout(function(){window.opener.document.querySelector("#hash").remove()},300);');
});
